...
import {ImpactVaultManager} from "./ImpactVaultManager.sol";
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function _updateYieldIndexSinceLastUpdate(
        ...
        unchecked {
            if (_isDeposit) {
                ...
                newAmount -= MathUpgradeable.min(
                    newAmount,
                    convertToYieldAsset(_amount)
                );
            }
        }
    ...
    /**
     * @notice Returns the APY of the underlying vault strategy, 18 decimals.
     */
